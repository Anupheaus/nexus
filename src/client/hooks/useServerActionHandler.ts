...
export type GetUseServerActionHandlerType<ActionType extends NexusAction<any, any, any>> =
  ActionType extends NexusAction<infer _Name, infer Request, infer Response>
 ...
 */
export function useServerActionHandler<Name extends string, Request, Response>(action: NexusAction<Name, Request, Response>) {
